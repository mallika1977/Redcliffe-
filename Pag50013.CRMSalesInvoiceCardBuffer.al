page 50013 "CRM Sales Invoice Card Buffer"
{
    PageType = API;
    APIGroup = 'demo';
    APIVersion = 'v1.0';
    ...
    EntityCaption = 'CRMSalesInvoice';
    EntityName = 'CRMSalesInvoice';

    EntitySetCaption = 'CRMSalesInvoices';
    EntitySetName = 'CRMSalesInvoices';

    ODataKeyFields = SystemId;
    SourceTable = "CRM Sales Invoice Header Buff";
    ...
    layout
    {
        area(content)
        {
            repeater(GroupName)
            {
                ...
                field("ProcessingCentre"; Rec."Processing Centre")
                {
                    ApplicationArea = All;
                }
                ...
                field("InvoiceDiscount"; Rec."Invoice Discount")
                {
                    ApplicationArea = All;
                }

            }
            part(CRMSalesInvoiceLines; "CRM Sales Invoice Subpage Buff")
            {
                ApplicationArea = all;
                Caption = 'CRM Sales Invoice Line';
    ...
    var
        ...
        RecCRMSInvHeader: Record "CRM Sales Invoice Header";
    ...
    begin
        ...
        IF Not RecLoc.Get(Rec."Location Code") then
            Error('Location code not found %1', Rec."Location Code");
        ...
        IF not RecCRMSInvHeader.FindFirst() then begin
            RecCRMSInvHeader.TransferFields(Rec);
            RecCRMSInvHeader.Insert(true);
        end;
