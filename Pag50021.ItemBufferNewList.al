page 50021 "Item Buffer New List"
{
    PageType = API;
    APIVersion = 'v1.0';
    APIPublisher = 'ANI';
    APIGroup = 'ItemBuffer';
    SourceTable = "Item Buffer New";
    Caption = 'Item Buffer New List';
    ApplicationArea = All;
    ...
    begin
        ...
        IF Rec."Item No." = '' then begin
            ...
            RecItem.Validate("Purch. Unit of Measure", Rec."Purch. Unit of Measure");
